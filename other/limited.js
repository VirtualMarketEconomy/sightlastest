...
try{
    eval("console.error('error!');");
    result = false;
}catch(e){
}

try{
    window.eval("console.error('error!');");
    result = false;
}catch(e){
}

try{
    window["eva" + "l"]("console.error('error!');");
    result = false;
}catch(e){
}
...
try{
    ...
    windowForEval["ev"+"al"]("console.error('error!');");
    result = false;
}catch(e){
}
...
try{
    ...
    that[windowEvalString]("console.error('error!');");
    result = false;
}catch(e){
}
...
try{
    (function(){
        var windowEvalDiv = document.createElement("div");
        windowEvalDiv.innerHTML = "<" + "sc" + "rip" + "t>eval('console.error('error!');');" + "</s" + "cr" + "ipt>";
        document.body.appendChild(windowEvalDiv);
        result = false;
    })();
}catch(e){
